...
class AlienInvasion():
	def __init__(self):
		...
		# Full-screen mode (comment previuos line and uncomment following 3 lines):
	...
	def _ship_hit(self):
		...
		if self.stats.ships_left > 0:
			...
			textboxGO = TextBox(self, "GAME OVER")
			textboxGO.draw_box_element()
	...
	def _wait(self):
		textbox = TextBox(self, "Collision! Press any key to continue")
		textbox.draw_box_element()
		pygame.display.update()
		sleep(1)
		while True:
			events = pygame.event.get()
	...
	def _update_screen(self):
		#self.screen.fill(self.settings.bg_color) #bg color instead of image
		...
		if not self.stats.game_active:
			self.play_button.draw_box_element()
